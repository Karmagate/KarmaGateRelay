...
<div class="subtitle">Lightweight, stateless WebSocket relay server for KarmaGate Bind.<br>End-to-end encrypted collaboration for security teams.</div>
</div>
...
<span class="endpoint-desc">WebSocket relay</span>
</div>
</div>
